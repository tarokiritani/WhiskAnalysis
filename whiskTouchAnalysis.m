function result = whiskTouchAnalysis(varargin)
...
expType = 'activeTouch'; % 'activeTouch' or 'passiveTouch'
...
dirName = ['C:\Users\kiritani\Documents\data\analysis\', expType ,'\', cellType, date, '-',num2str(c(4)), num2str(c(5))];
mkdir(dirName);
